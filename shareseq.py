...
def my_args():
	...
	genome.add_argument('-g','--genome_config',  help="genome config file specifing: index file, black list, chrom size and effectiveGenomeSize", default='genome.yaml',type=str)
